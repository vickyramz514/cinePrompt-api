...
import EtfMetrics from "./EtfMetrics.js";
...
Stock.hasOne(EtfMetrics, { foreignKey: "symbol", sourceKey: "symbol" });
EtfMetrics.belongsTo(Stock, { foreignKey: "symbol", targetKey: "symbol" });
