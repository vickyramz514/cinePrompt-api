...
const subscriptionPlans = [
  ...
  { name: 'Starter', slug: 'starter', description: 'For casual creators', priceCents: 9900, currency: 'INR', credits: 500, creditsPerMonth: 500, billingCycle: 'monthly', razorpayPlanId: null, features: ['500 credits/month', '1080p output', 'All templates'], isActive: true, sortOrder: 2 }, // ₹99/mo in test Razorpay — paise; keep in sync with linked plan_id
